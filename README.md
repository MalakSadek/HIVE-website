...
Click on the [Use Template](https://github.com/surjithctly/nextly-template/generate) button on this page to clone this repository to your GitHub account. Or you can also clone this repository using terminal or bash. 
